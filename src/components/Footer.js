					...
					{/* <div className = "media-links"> */}
						...
						<div className = "col-sm-1 col-md-1">
							<div className = "facebook">
								<a href = "#"><img className = "img-responsive" src = {facebook}></img></a>
							</div>
						</div>

						<div className = "col-sm-1 col-md-1">
							<div className = "linkedin">
								<a href = "#"><img className = "img-responsive" src = {linkedin}></img></a>
							</div>
						</div>

						<div className = "col-sm-1 col-md-1">
							<div className = "pinterest">
								<a href = "#"><img className = "img-responsive" src = {pinterest}></img></a>
							</div>
						</div>

						<div className = "col-sm-1 col-md-1">
							<div className = "email-icon">
								<a href = "#"><img className = "img-responsive" src = {email}></img></a>
							</div>
						</div>
                        <div className = "col-sm-4"></div>
					{/* </div> */}
